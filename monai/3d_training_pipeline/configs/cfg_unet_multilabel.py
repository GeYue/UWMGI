...
cfg.train = True
cfg.eval = True
cfg.eval_epochs = 5 #5 / 2
cfg.start_eval_epoch = 19 #19 / 200  # when use large lr, can set a large num
...
# val
cfg.roi_size = (-1, -1, -1) #(224, 224, 80) / (224, 224, 64) 
cfg.sw_batch_size = 4
...
cfg.train_transforms = Compose(
    [
        ...
        # ),
        ############      !!!!!!!!!!!!!!!!!!!!!!!! Lambdad(keys="image", func=lambda x: x / x.max()),
        #SpatialPadd(keys=("image", "mask"), spatial_size=cfg.img_size, method="end"),
